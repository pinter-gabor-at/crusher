...
public final class ModItemTagProvider extends FabricTagsProvider.ItemTagsProvider {
	...
	protected void addTags(final HolderLookup.@NonNull Provider registries) {
		...
		valueLookupBuilder(SAND_SOURCES)
			.add(
				Items.GRAVEL,
		...
		valueLookupBuilder(RED_SAND_SOURCES)
			.add(
		...
		valueLookupBuilder(NORMAL_FRUIT_FOODS)
			.add(
				Items.APPLE, Items.CHORUS_FRUIT, Items.MELON_SLICE);
		valueLookupBuilder(NORMAL_VEGETABLE_FOODS)
			.add(
		...
		valueLookupBuilder(WOODEN_SIGNS)
		...
		valueLookupBuilder(WOODEN_FENCE_GATES)
		...
		valueLookupBuilder(COPPER_BLOCKS)
			.add(
		...
		valueLookupBuilder(CUT_COPPER_BLOCKS)
			.add(
		...
		valueLookupBuilder(CHISELED_COPPER_BLOCKS)
			.add(
		...
		valueLookupBuilder(COPPER_DOORS)
			.add(
		...
		valueLookupBuilder(COPPER_TRAPDOORS)
			.add(
		...
		valueLookupBuilder(COPPER_GRATES)
			.add(
		...
		valueLookupBuilder(COPPER_BULBS)
			.add(
		...
		valueLookupBuilder(COPPER_SLABS)
			.add(
		...
		valueLookupBuilder(COPPER_STAIRS)
			.add(
