...
public final class ModRecipeGenerator extends ProcessingRecipeGenerator {
	...
	private void generateCrusherRecipes() {
		...
		createCrusherRecipe(ModItemTagProvider.WOODEN_STAIRS, 1, Items.STICK, 3);
		createCrusherRecipe(ModItemTagProvider.WOODEN_SLABS, 1, Items.STICK, 1);
		createCrusherRecipe(ModItemTagProvider.WOODEN_PRESSURE_PLATES, 1, Items.STICK, 4);
		createCrusherRecipe(ModItemTagProvider.WOODEN_SIGNS, 1, Items.STICK, 4);
		...
		createCrusherRecipe(Items.LILY_OF_THE_VALLEY, 1, Items.DYE.white(), 2);
		createCrusherRecipe(Items.BONE_MEAL, 1, Items.DYE.white(), 2);
		createCrusherRecipe(Items.ORANGE_TULIP, 1, Items.DYE.orange(), 2);
		createCrusherRecipe(Items.TORCHFLOWER, 1, Items.DYE.orange(), 2);
		createCrusherRecipe(Items.OPEN_EYEBLOSSOM, 1, Items.DYE.orange(), 2);
		createCrusherRecipe(Items.ALLIUM, 1, Items.DYE.magenta(), 2);
		createCrusherRecipe(Items.LILAC, 1, Items.DYE.magenta(), 4);
		createCrusherRecipe(Items.BLUE_ORCHID, 1, Items.DYE.lightBlue(), 2);
		createCrusherRecipe(Items.DANDELION, 1, Items.DYE.yellow(), 2);
		createCrusherRecipe(Items.SUNFLOWER, 1, Items.DYE.yellow(), 4);
		createCrusherRecipe(Items.PEONY, 1, Items.DYE.pink(), 4);
		createCrusherRecipe(Items.PINK_PETALS, 1, Items.DYE.pink(), 2);
		createCrusherRecipe(Items.PINK_TULIP, 1, Items.DYE.pink(), 2);
		createCrusherRecipe(Items.CLOSED_EYEBLOSSOM, 1, Items.DYE.gray(), 2);
		createCrusherRecipe(Items.OXEYE_DAISY, 1, Items.DYE.lightGray(), 2);
		createCrusherRecipe(Items.WHITE_TULIP, 1, Items.DYE.lightGray(), 2);
		createCrusherRecipe(Items.AZURE_BLUET, 1, Items.DYE.lightGray(), 2);
		createCrusherRecipe(Items.PITCHER_PLANT, 1, Items.DYE.cyan(), 4);
		createCrusherRecipe(Items.LAPIS_LAZULI, 1, Items.DYE.blue(), 3);
		createCrusherRecipe(Items.LAPIS_BLOCK, 1, Items.DYE.blue(), 32);
		createCrusherRecipe(Items.CORNFLOWER, 1, Items.DYE.blue(), 2);
		createCrusherRecipe(Items.COCOA_BEANS, 1, Items.DYE.brown(), 2);
		createCrusherRecipe(Items.CACTUS, 1, Items.DYE.green(), 2);
		createCrusherRecipe(Items.ROSE_BUSH, 1, Items.DYE.red(), 4);
		createCrusherRecipe(Items.POPPY, 1, Items.DYE.red(), 2);
		createCrusherRecipe(Items.BEETROOT, 1, Items.DYE.red(), 2);
		createCrusherRecipe(Items.RED_TULIP, 1, Items.DYE.red(), 2);
		createCrusherRecipe(Items.REDSTONE, 1, Items.DYE.red(), 3);
		createCrusherRecipe(Items.REDSTONE_BLOCK, 1, Items.DYE.red(), 32);
		createCrusherRecipe(Items.INK_SAC, 1, Items.DYE.black(), 2);
		createCrusherRecipe(Items.WITHER_ROSE, 1, Items.DYE.black(), 2);
		createCrusherRecipe(Items.CHARCOAL, 1, Items.DYE.black(), 4);
		createCrusherRecipe(Items.COAL, 1, Items.DYE.black(), 3);
		createCrusherRecipe(Items.COAL_BLOCK, 1, Items.DYE.black(), 32);
		// Concrete powder from concrete.
		createCrusherRecipe(Items.CONCRETE.white(), 1, Items.CONCRETE_POWDER.white(), 1);
		createCrusherRecipe(Items.CONCRETE.orange(), 1, Items.CONCRETE_POWDER.orange(), 1);
		createCrusherRecipe(Items.CONCRETE.magenta(), 1, Items.CONCRETE_POWDER.magenta(), 1);
		createCrusherRecipe(Items.CONCRETE.lightBlue(), 1, Items.CONCRETE_POWDER.lightBlue(), 1);
		createCrusherRecipe(Items.CONCRETE.yellow(), 1, Items.CONCRETE_POWDER.yellow(), 1);
		createCrusherRecipe(Items.CONCRETE.lime(), 1, Items.CONCRETE_POWDER.lime(), 1);
		createCrusherRecipe(Items.CONCRETE.pink(), 1, Items.CONCRETE_POWDER.pink(), 1);
		createCrusherRecipe(Items.CONCRETE.gray(), 1, Items.CONCRETE_POWDER.gray(), 1);
		createCrusherRecipe(Items.CONCRETE.lightGray(), 1, Items.CONCRETE_POWDER.lightGray(), 1);
		createCrusherRecipe(Items.CONCRETE.cyan(), 1, Items.CONCRETE_POWDER.cyan(), 1);
		createCrusherRecipe(Items.CONCRETE.purple(), 1, Items.CONCRETE_POWDER.purple(), 1);
		createCrusherRecipe(Items.CONCRETE.blue(), 1, Items.CONCRETE_POWDER.blue(), 1);
		createCrusherRecipe(Items.CONCRETE.brown(), 1, Items.CONCRETE_POWDER.brown(), 1);
		createCrusherRecipe(Items.CONCRETE.green(), 1, Items.CONCRETE_POWDER.green(), 1);
		createCrusherRecipe(Items.CONCRETE.red(), 1, Items.CONCRETE_POWDER.red(), 1);
		createCrusherRecipe(Items.CONCRETE.black(), 1, Items.CONCRETE_POWDER.black(), 1);
	...
	private void generateCompressorRecipes() {
		...
		createCompressorRecipe(Items.COPPER_INGOT, 9, Items.COPPER_BLOCK.weathering().unaffected(), 1);
