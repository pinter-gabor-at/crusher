...
public final class CrusherRecipeGenerator {
	...
	public static void generateRecipes(final @NonNull ProcessingRecipeGenerator generator) {
		...
		generator.createRecipe(Tags.Items.SANDSTONE_BLOCKS, 1, Items.SAND, 4);
		...
		generator.createRecipe(Tags.Items.SANDSTONE_SLABS, 1, Items.SAND, 2);
		generator.createRecipe(Items.SANDSTONE_SLAB, 1, Items.SAND, 2);
		generator.createRecipe(Tags.Items.SANDSTONE_STAIRS, 1, Items.SAND, 6);
		...
		generator.createRecipe(Tags.Items.SANDSTONE_RED_BLOCKS, 1, Items.RED_SAND, 4);
		...
		generator.createRecipe(Tags.Items.FOODS_BERRY, 1, Items.SUGAR, 1);
		generator.createRecipe(Tags.Items.FOODS_CANDY, 1, Items.SUGAR, 1);
		generator.createRecipe(Tags.Items.FOODS_COOKIE, 1, Items.SUGAR, 1);
		generator.createRecipe(Tags.Items.FOODS_PIE, 1, Items.SUGAR, 1);
		generator.createRecipe(ModItemTagProvider.FOODS_NORMAL_FRUIT, 1, Items.SUGAR, 1);
		generator.createRecipe(Tags.Items.FOODS_FOOD_POISONING, 1, Items.ROTTEN_FLESH, 1);
		generator.createRecipe(Tags.Items.FOODS_RAW_FISH, 1, Items.ROTTEN_FLESH, 1);
		generator.createRecipe(Tags.Items.FOODS_COOKED_FISH, 1, Items.ROTTEN_FLESH, 1);
		generator.createRecipe(Tags.Items.FOODS_RAW_MEAT, 1, Items.ROTTEN_FLESH, 1);
		generator.createRecipe(Tags.Items.FOODS_COOKED_MEAT, 1, Items.ROTTEN_FLESH, 1);
		generator.createRecipe(Tags.Items.FOODS_BREAD, 4, Items.DIRT, 1);
		generator.createRecipe(Tags.Items.FOODS_EDIBLE_WHEN_PLACED, 1, Items.DIRT, 1);
		generator.createRecipe(Tags.Items.FOODS_SOUP, 4, Items.DIRT, 1);
		generator.createRecipe(ModItemTagProvider.FOODS_NORMAL_VEGETABLE, 4, Items.DIRT, 1);
